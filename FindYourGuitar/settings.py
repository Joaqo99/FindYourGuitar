"""
Django settings for FindYourGuitar project.
...
SECRET_KEY = 'django-insecure-_6oqy7&0mfx38i1$2ho@lr(0*z*)x+1h^62_gm2cw#7pozk6y5'
...
ROOT_URLCONF = 'FindYourGuitar.urls'
...
WSGI_APPLICATION = 'FindYourGuitar.wsgi.application'
